...
<form   method="POST" action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data" id="form">
@csrf
                ...
                <div class="col-md">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="name" >{{ __('messages.name_product') }} *</label>
                            ...
                            <div class="form-group">
                                <label for="category_id">{{ __('messages.name_category') }} *</label>
                                  @php
                                    $categorys =  App\Helpers\Helper::getAllIdCategory();
                                  @endphp
                                  <select class="form-control" name="category_id" id="category">
                                      @foreach($categorys as $item)
                                          <option value="{{$item->id}}" {{ old('category_id', $product->catrgory_id) == $item->id ? 'selected' : '' }}>{{$item->name}}</option>
                                      @endforeach
                                  </select>
                            </div>
                        </div>
                            ...
                            <div style = "margin-top:25px;">
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url({{asset($product->avatar)}});">
                                        </div>
                                    </div>
